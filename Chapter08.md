...
Goblins sometimes use dire wolves as mounts. Each gang encountered has a 5% chance to be mounted on dire wolves. Each warband encountered has a 20% chance to have ¼ of its gangs mounted on dire wolves. If a gang is mounted, its champion will also be mounted. If any gangs within a warband are mounted, the sub-chieftain will be mounted, and if any warbands within a lair or village are mounted, the chieftain will be mounted.
