...
### Sword +3, frost brand: The frost brand is a sword +6 against monsters that live in a hot environment or use a fire-based attack. The sword sheds light as a torch when the temperature drops below 0°F. At such times it cannot be concealed when drawn, nor can its light be shut off. Its wielder is protected from fire in the same manner as wearing a ring of fire resistance. A frost brand extinguishes all non-magical fires in a 10’ area when touched to a flame.
