...
1.    -4 decrease to an ability score (minimum 1).
2.    -4 penalty on attack throws and saves.
3.    Prime requisite halved (minimum 1).
4.    Each round of combat, the target has a 50% chance to act normally; otherwise, it takes no action.
